...
public class Application {
	public static void main(String [ ]args) {
		...
		Ct[1]=new CentreTri(14,"Palace Tri", "5 rue pouillon","Marselle",15000);
		Ct[2]=new CentreTri(120,"The Place to Tri", "5 rue cergy?","Lyonne",23000);
		...
		while(quit != 0) {
			...
			System.out.println("Quel centre de tri voulez-vous utiliser ?");
			for(int i=0;i<Ct.length;i++) {
				System.out.println(i+"/ "+Ct[i].getNom());
			}
		...
		P1=new Poubelle(1, Ct[1],"verre", "Place de la poubelle", 0, 2000);
